...
def attack(char_name: str, char_class: str) -> str:
    """Определяет количество нанесённого урона"""
...
def defence(char_name: str, char_class: str) -> str:
    """Определяет кол-во заблокированного урона"""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Показывает результат специальных умений"""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Тренируемся использовать команды действий"""
    if char_class == 'warrior':
...
def main() -> None:
    """Стартовый экран, где выбирается имя персонажа"""
    run_screensaver()
